                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-list-item">
                                    ...
                                    <div class="product-content-list">
                                        <h5 class="product-name"><a href="product-details.html">商品名称</a></h5>
                                        <div class="price-box">
                                        ...
                                        <div class="button-group-list">
                                            <a class="btn-big" href="cart.html" data-toggle="tooltip" title="添加购物车"><i class="lnr lnr-cart"></i>添加购物车</a>
                                            <a href="#" data-toggle="modal" data-target="#quick_view"><span data-toggle="tooltip" title="快速预览"><i class="lnr lnr-magnifier"></i></span></a>
                                            <a href="wishlist.html" data-toggle="tooltip" title="添加收藏"><i class="lnr lnr-heart"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- product list item end -->
